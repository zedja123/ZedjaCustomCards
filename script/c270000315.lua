...
function s.initial_effect(c)
	...
	-- Fusion Summon
	local e2=Fusion.CreateSummonEff(aux.FilterBoolFunction(Card.IsCode(270000313)),Fusion.OnFieldMat(Card.IsAbleToDeck),s.fextra,Fusion.ShuffleMaterial,nil,nil,nil,nil,nil,nil,nil,nil,nil,s.extratg)
