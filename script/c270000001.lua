...
local s,id,o=GetID()
function c270000001.initial_effect(c)
...
function s.filter(c,e,tp)
	return c:IsSetCard(0xf10) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
