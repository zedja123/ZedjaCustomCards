...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0xf13) and c:IsType(TYPE_PENDULUM) and (c:IsLocation(LOCATION_EXTRA) and Duel.GetLocationCountFromEx(tp,rp,nil,c)>0 or c:IsLocation(LOCATION_GRAVE))
