...
function s.initial_effect(c)
	...
	Synchro.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xf16),1,99,Synchro.NonTunerEx(Card.IsType,TYPE_LINK),1,99,s.exmatfilter)  -- "Milacresy" Tuner and non-Tuner
	c:EnableReviveLimit()
