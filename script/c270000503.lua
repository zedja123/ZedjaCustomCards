...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.shfilter, tp, LOCATION_GRAVE+LOCATION_REMOVED, 0, 3, nil, 0xf16) end
	local g=Duel.SelectMatchingCard(tp, s.shfilter, tp, LOCATION_GRAVE+LOCATION_REMOVED, 3, 3, nil, 0xf16)
