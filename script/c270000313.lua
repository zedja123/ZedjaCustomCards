...
function s.initial_effect(c)
	...
	e1:SetOperation(function(c,e,tp,eg,ep,ev,re,r,rp) if Duel.NegateEffect(ev) then Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP) end end)
	c:RegisterEffect(e1)
